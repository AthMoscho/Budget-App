...
var UIController = (function () {
    ...
    var DOMstrings = {
        ...
        container: '.container',
        exprensesPrecLabel: '.item__percentage',
    ...
    return {
        ...
        displayPrecentages: function(precentages) {
            var fields = document.querySelectorAll(DOMstrings.exprensesPrecLabel);
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var updatePrecentages = function() {
        ...
        //read precentages for budget controller
    ...
    var ctrlAddItem = function () {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0)
            ...
            //calculate and update the precentages
            updatePrecentages();
        }
